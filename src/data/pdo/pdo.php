...
class Pdo extends Core\Assembly implements Data\IPdo
{
     ...
     * @return bool
     *
     * @throws NestedTransactionUnsupportedException If starting a more
     *                                               transaction while in
     *                                               another transaction.
     */
     ...
     * @return bool
     *
     * @throws NoActiveTransactionException If there is no active transaction.
     */
     ...
     *                                      which generated by another data
     *                                      object.
     */
    public function realize(Data\IPdoStatement $stmt)
    {
        if ($stmt->getPdo() != $this) {
            throw new DismatchedStatementException;
        }
