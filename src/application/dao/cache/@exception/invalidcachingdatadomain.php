...
/**
 * Be raised on invalid caching data domain.
 *
...
final class InvalidCachingDataDomainException extends Core\Exception
{
     ...
     * {@inheritdoc}
     *
     * > Defined as `0x80020802`.
     */
    const CODE = 0x80020802;

    /**
     * {@inheritdoc}
     *
     * > Defined as `invalid caching data domain`.
     */
    const MESSAGE = 'invalid caching data domain';
}
